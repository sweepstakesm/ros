...
(function() {
    var
        _flixLoader = {
            ...
            isAb: function(type) {
                try {
                    if (!this.ab.d.hasOwnProperty(this.mappingTable['data-flix-distributor']['value'])) {
                        return false;
                    }
                    if (this.ab[type]['mpn'].hasOwnProperty((this.mappingTable['data-flix-mpn']['value'] != null ? this.mappingTable['data-flix-mpn']['value'] : '').toLowerCase())) {
                        return true;
                    }
                    if (this.ab[type]['ean'].hasOwnProperty((this.mappingTable['data-flix-ean']['value'] != null ? this.mappingTable['data-flix-ean']['value'] : '').toLowerCase())) {
                        return true;
                    }
                } catch (e) {
                    this.log(e.message);
            ...
            init: function() {
                try {
                    ...
                    if (typeof URLSearchParams == 'function') {
                        ...
                        if (this.abc && typeof this.abc[d_id] != "undefined") {
                            dt_ids[d_id] = this.abc[d_id];
                        }
                        if (urlParams.get('ab_d_id') && urlParams.get('ab_t_id')) {
                            d_id = urlParams.get('ab_d_id');
                            dt_ids[d_id] = [urlParams.get('ab_t_id')];
                        }
            ...
            _s: function(url, append_dom, options) {
                ...
                for (var i in options) {
                    i == "id" ? _fscript.id = options[i] : _fscript.setAttribute(i, options[i]);
                }
            ...
            setGvid: function() {
                ...
                this._s(switch_base, document.getElementsByTagName('head')[0], {
                    "id": "data-flix-t-script"
                });
            ...
            setLoadCallback: function(cFunction, ftype) {
                try {
                    if (cFunction && typeof(cFunction) === "function") {
                        switch (ftype) {
                            case "inpage":
                                this._loadInpageCallback = cFunction;
                                break;
                            case "minisite":
                                this._loadMinisiteCallback = cFunction;
                                break;
                            case "noshow":
                                this._loadNoshowCallback = cFunction;
                                break;
                            case "mouseflow":
                                this._loadMouseFlowCallback = cFunction;
                                break;
                            default:
                                this._loadCallback = cFunction;
                                break;
                        }
                    } else {
                        throw cFunction + " is not a function";
                    }
                } catch (e) {
                    try {
                        console.log(e);
